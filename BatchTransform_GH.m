...
%% Settings
% 1)  point to the datafoldern where the inputs .mvnx are
datafolder = 'C:\GiacomoDR\OpenSense\CO_p3_walk\Xsens_data_processing';

% 2) name of the .mvnx file that you want to convert in .mat format
files = dir(fullfile(datafolder,'walk-001.mvnx'));

% 3) add path with TBM software tools
addpath(genpath('C:\GiacomoDR\OpenSense\DataTransform_Xsens_to_OS\Functions'));

% 4) Insert the save name of the rawData on line 106
