...
clear; close all; clc;
%% Settings
% 1) addpath of MexFiles folder
addpath('C:\GiacomoDR\OpenSense\DataTransform_Xsens_to_OS\CPP_Projects\MexFiles');

% 2) Path where you are working on
DataPath = 'C:\GiacomoDR\OpenSense\CO_p3_walk\Xsens_data_processing';

% 3) rawData.mat that want to convert in .sto
R = load(fullfile(DataPath,'rawData_CO_p3_walk_002.mat'));

% 4) extern folder where the file .sto will be saved
OutPath = [DataPath '_Osens'];

% 5) Set the sensors you need. The model is the gait2392 so the important headers and IMU sensors are these below
